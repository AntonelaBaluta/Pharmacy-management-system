          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3><i class="fa fa-pencil"></i> Adauga Distribuitor</h3>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <form id="distributor-form" data-parsley-validate class="form-horizontal form-label-left" action="insert-distributor.php" method="POST">
                  <div class="item form-group">
                  <div class="col-md-8 col-sm-8 offset-md-2">
                    <input type="text" name="nume" class="form-control has-feedback-left" placeholder="Nume Distribuitor">
                ...
                <div class="item form-group">
                  <div class="col-md-8 col-sm-8 offset-md-2">
                    <input type="text" name="data-aprovizionare" class="form-control has-feedback-left" placeholder="Data Aprovizionare (de forma YYYY-MM-DD)">
                    <span class="fa fa-list-alt form-control-feedback left" aria-hidden="true"></span>
                  </div>
                </div>
                <div class="item form-group">
